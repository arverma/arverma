...
I am **Aman Ranjan Verma**, a **Senior Data Engineer** at [**QuillBot**](https://www.linkedin.com/company/quillbot) with **7+ years** of experience building production-grade data platforms and pipelines (ex-**Flipkart**, ex-**Sigmoid**).

**Impact snapshot**
- Built and scaled platform capabilities for event tracking, governance, and analytics use cases.
- Architected backend services and data workflows with low-latency performance (p99 < 15 ms, 10K+ QPS).
- Promoted within 1 year at Flipkart for ownership and delivery in high-impact fintech initiatives. 
- 100% of my performance reviews have been 'Exceeds Expectations' till date.

Gold Medalist (B.Tech), IIIT Manipur · MBA, IIM Bodh Gaya ('27).
